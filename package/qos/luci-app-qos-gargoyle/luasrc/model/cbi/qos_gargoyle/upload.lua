...
m = Map(qos_gargoyle, i18n.translate("Upload Settings"))
m.template = "qos_gargoyle/list_view"

class_s = m:section(TypedSection, "upload_class", i18n.translate("Service Classes"),
	i18n.translate("Each upload service class is specified by three parameters: percent <br />bandwidth at capacity, minimum bandwidth and maximum bandwidth."))
...
rule_s = m:section(TypedSection, "upload_rule",i18n.translate("Classification Rules"),
